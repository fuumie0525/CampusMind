...
class SkillManager:
    ...
    支持两种常用结构：
      1. skills/campus_network/SKILL.md
      2. skills/campus_network.json / skills/campus_network.md / skills/campus_network.txt
    """
