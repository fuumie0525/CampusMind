...
DEFAULT_INTENT_CASES: List[IntentTestCase] = [
    IntentTestCase("学校奖学金评定条件是什么？", "campus_policy"),
    IntentTestCase("在读证明怎么办理？", "student_affairs"),
    IntentTestCase("校园网认证失败，一直无法上网", "network_support"),
    IntentTestCase("校园卡丢了怎么挂失？", "campus_card"),
    IntentTestCase("宿舍空调坏了怎么报修？", "dorm_service"),
    IntentTestCase("报修几天了还没人处理", "complaint"),
    IntentTestCase("我要转人工老师", "escalation"),
    IntentTestCase("你好", "greeting"),
]

DEFAULT_DIALOG_CASES: List[Dict[str, Any]] = [
    {"question": "我想申请在读证明，需要准备什么材料？"},
    {"question": "宿舍校园网连上了，但是认证后还是不能上网"},
    {"question": "校园卡刚才重复扣费了，我应该怎么处理？"},
    {"question": "宿舍空调漏水，后勤报修流程是什么？"},
    {"turns": ["我学生证丢了", "我已经挂失了", "下一步怎么补办？"]},
]
